...
latex_documents = [
    (master_doc, 'skelpy.tex', 'skelpy Documentation',
     'dks', 'manual', False),
]
...
man_pages = [
    (master_doc, 'skelpy', 'skelpy Documentation',
     [author], 7)
]
...
texinfo_documents = [
    (master_doc, 'skelpy', 'skelpy Documentation',
     'dks', 'skelpy', 'simple template tool for a python project.',
     'Miscellaneous', False),
]
